...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Search 27,000+ paint colors by name, number, or hex code across all major brands.",
    alternates: { canonical: "https://www.paintcolorhq.com/search" },
    ...(hasQuery && { robots: { index: false, follow: true } }),
    openGraph: {
      title: "Search Paint Colors",
      description: "Search 27,000+ paint colors by name, number, or hex code across all major brands.",
      ...
      <section className="relative pt-24 px-6 md:px-12 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-on-surface-variant max-w-xl leading-relaxed">
            Search 27,000+ colors by name, number, or hex code across 14 brands.
          </p>
        </div>
      </section>
