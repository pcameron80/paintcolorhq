...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Paint Color HQ uses CIEDE2000 color science to match 27,000+ colors across 14 brands. Independent, data-driven paint color tools.",
  ...
  return (
    <div className="flex min-h-screen flex-col bg-surface">
      ...
      <JsonLd data={{
        ...
        description: "Learn how Paint Color HQ uses CIEDE2000 color science to match 27,000+ paint colors across 14 brands.",
        url: "https://www.paintcolorhq.com/about",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4 text-on-surface-variant leading-relaxed">
              <p>
                ...
                <strong className="text-on-surface">over 27,000 colors across 14 major paint brands</strong>{" "}
