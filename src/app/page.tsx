...
export const metadata: Metadata = {
  ...
  description:
    "Discover paint colors you love from 27,000+ shades across 14 brands, preview them on a wall, and find your color in the brand you can buy — free, no signup.",
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Every color has a hidden tint — warm (yellow/pink), cool (blue/gray), or neutral — that shows up under different lighting. All 27,000+ colors in our database are tagged so you can filter by undertone and avoid clashing with your existing trim, flooring, or cabinets.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <section className="relative pt-24 px-6 md:px-12 py-20 flex flex-col lg:flex-row gap-12 items-center max-w-7xl mx-auto overflow-hidden">
        <div className="lg:w-1/2 z-10">
          <span className="inline-block px-3 py-1 bg-surface-container-highest text-primary text-[10px] uppercase tracking-[0.2em] font-bold mb-6 rounded">
            27,000+ colors &middot; 14 brands &middot; 100% free
          </span>
          ...
          <p className="text-lg text-on-surface-variant max-w-md mb-10 leading-relaxed">
            Browse 27,000+ shades across 14 brands, preview your favorites on a real wall, then find that exact color in the brand you can actually buy.
          </p>
      ...
      <JsonLd data={{
        ...
        description: "Discover, preview, and compare 27,000+ paint colors across 14 brands — find a color you love, see it on a wall, and get it in the brand you can buy. Cross-brand matches use CIEDE2000 Delta E. Free, no signup.",
        potentialAction: {
          "@type": "SearchAction",
      ...
      <JsonLd data={{
        ...
        description: "Paint Color HQ helps you discover, preview, and compare 27,000+ paint colors across 14 brands, then find your color in the brand you can buy. Cross-brand matches use the CIEDE2000 Delta E formula. Free, no signup.",
      ...
      <JsonLd data={[
        { "@context": "https://schema.org", "@type": "WebApplication", name: "Room Color Visualizer", url: "https://www.paintcolorhq.com/tools/room-visualizer", applicationCategory: "DesignApplication", operatingSystem: "Web browser", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, description: "Preview 27,000+ paint colors on walls, trim, and floor in a realistic room scene." },
