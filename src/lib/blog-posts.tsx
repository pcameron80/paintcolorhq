...
const blogPosts: BlogPost[] = [
    ...
    content: () => (
      <>
        ...
        <p className="mt-4 text-gray-700 leading-relaxed italic">
          Based on our analysis of 27,000+ paint colors across 14 brands using{" "}
          <a
  ...
  /* ──────────────── Post 7 ──────────────── */
  {
    ...
    author: "Philip Cameron",
    excerpt:
      "The definitive guide to cross-brand paint color matching. Learn how CIEDE2000, Delta E, and a 27,000+ color database find exact equivalents.",
    coverColor: "#6B8F71",
  ...
  /* ──────────────── Post 8 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <p className="mt-4 text-gray-700 leading-relaxed">
          Found a white you love from one brand but need to buy from another? Here are the closest cross-brand matches. Use our <Link href="/search" className="text-brand-blue hover:underline">color search</Link> to find matches across 27,000+ colors from 14 brands, or try the <Link href="/compare" className="text-brand-blue hover:underline">compare tool</Link> to see the Delta E difference between any two whites.
        </p>
  ...
  /* ──────────────── Post 10 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <p className="mt-4 text-gray-700 leading-relaxed">
          Whatever direction you choose, use our <Link href="/search" className="text-brand-blue hover:underline">color search</Link> to explore 27,000+ colors across 14 brands, and find the perfect match for your next project. Preview any of these popular shades with our <Link href="/tools/room-visualizer" className="text-brand-blue hover:underline">room visualizer</Link> or build a full palette with our <Link href="/tools/palette-generator" className="text-brand-blue hover:underline">palette generator</Link>.
        </p>
      </>
    ),
  },
  ...
  /* ──────────────── Post 15 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <p className="mt-4 text-gray-700 leading-relaxed">
          <strong>Match across brands.</strong> Found a color you love at one brand but prefer another brand&apos;s paint formula? Paint Color HQ uses the CIEDE2000 color-difference formula to calculate precise perceptual matches across all 14 brands in our 27,000+ color database. Use our <Link href="/search" className="text-brand-blue hover:underline">color search</Link> to find the closest match — any result with a Delta E under 2.0 is virtually indistinguishable to the human eye. Or use our <Link href="/tools/color-identifier" className="text-brand-blue hover:underline">color identifier</Link> to upload a photo of a nursery you love and identify the exact paint color.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
  ...
  /* ──────────────── Pillar — Best Blue Paint Colors ──────────────── */
  {
    ...
    author: "Philip Cameron",
    excerpt:
      "Fourteen designer-favorite blues ranked by undertone, LRV, and room application — from airy sky blues to dramatic naval. Every pick verified against our 27,000+ color database with cross-brand matches.",
    coverColor: "#4A6B8F",
