  ...
  /* ──────────────── Post 1 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold">Sherwin-Williams: Wholesome</h2>
        ...
        <h2 className="mt-10 text-2xl font-bold">Benjamin Moore: Cinnamon Slate</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Behr: Rumors</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">PPG: Cracked Pepper</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Valspar: Encore</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">The Common Thread</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
  ...
  /* ──────────────── Post 2 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold">How We Match Colors</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Revere Pewter → Accessible Beige</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Simply White → Extra White</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Hale Navy → Naval</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Edgecomb Gray → Agreeable Gray</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Chantilly Lace → High Reflective White</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Finding Your Own Matches</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
  ...
  /* ──────────────── Post 3 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold">What Are Undertones?</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">The Most Common Gray Undertones</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">How to Identify Undertones</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Why Lighting Changes Everything</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Choosing Safe Neutrals</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
  ...
  /* ──────────────── Post 4 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold">Crisp Whites</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Moody Greens</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Warm Neutrals</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Bold Statement Colors</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Soft Blues</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
  ...
  /* ──────────────── Post 5 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold">Price Comparison</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Where to Buy</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Color Selection</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Paint Quality</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Best For…</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Can You Mix Brands?</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
  ...
  /* ──────────────── Post 6 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold">Muted Greens</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Soft Lavender</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Tips for Bedroom Colors</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
  ...
  /* ──────────────── Post 7 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold">Why Paint Store Matching Falls Short</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Understanding Delta E 2000</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Step-by-Step: Finding Your Match</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Cross-Brand Matching in Action</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">When a Perfect Match Doesn&apos;t Exist</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
  ...
  /* ──────────────── Post 8 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold">The Three Categories of White</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Best True Whites</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Best Warm Whites</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Best Cool Whites</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">How to Choose</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
  ...
  /* ──────────────── Post 9 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold">What Makes a Color Warm or Cool?</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">How Lighting Shifts Temperature</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Building a Cohesive Palette</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Warm Colors for Your Home</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Cool Colors for Your Home</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">When to Break the Rules</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
  ...
  /* ──────────────── Post 10 ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold">The Top 5 Overall</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Biggest Trend: Green Everything</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">The Warm Neutral Takeover</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Navy Holds Strong</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold">Looking Ahead to 2026</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
