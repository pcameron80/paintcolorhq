  ...
  /* ──────────────── Post 0 (newest) ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#F6F7F4" name="Ultra White" brand="Valspar" href="/colors/valspar/ultra-white-7006-24" /> — 7006-24, LRV 93. Valspar&apos;s clean, bright benchmark white with no obvious undertone. Use it for trim, ceilings, and modern rooms that want crisp contrast. Its closest match across brands is Sherwin-Williams UltraWhite, with Benjamin Moore Distant Gray and Behr Ultra Pure White nearly as close — so this is an easy color to source anywhere.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#F2F0EA" name="Swiss Coffee" brand="Valspar" href="/colors/valspar/swiss-coffee-7002-16" /> — 7002-16, LRV 87. The warm, soft white for walls that should feel inviting rather than stark. It is a near-exact match for Benjamin Moore Alabaster (and Behr Whisper White) — useful, because Alabaster is one of the most popular warm whites in the country and this is the Lowe&apos;s route to the same look.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#F1EEE4" name="Dove White" brand="Valspar" href="/colors/valspar/dove-white-7002-7" /> — 7002-7, LRV 86. A soft creamy white that sits between Ultra White and a true off-white. It matches PPG Atrium White almost exactly and lands close to Benjamin Moore Dune White. Browse the full <Link href="/colors/family/white" className="text-brand-blue hover:underline">white color family</Link> for more options.
        </p>
        ...
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#E6DECF" name="Cream in my Coffee" brand="Valspar" href="/colors/valspar/cream-in-my-coffee-3003-10c" /> — 3003-10C, LRV 74. A warm, creamy greige for living rooms and bedrooms that want softness without going beige. It matches Benjamin Moore Sonnet closely and pairs naturally with white trim and warm wood.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#DAD4C8" name="Warm Putty" brand="Valspar" href="/colors/valspar/warm-putty-6006-1a" /> — 6006-1A, LRV 66. A balanced putty neutral that reads warm but never yellow. Its closest cross-brand neighbors include Sherwin-Williams Limewash and Benjamin Moore Sea Salt, making it a flexible whole-home color for open-plan spaces.
        </p>

        <h2 className="mt-10 text-2xl font-bold text-gray-900">Best Valspar Grays</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#CDCBC8" name="Filtered Shade" brand="Valspar" href="/colors/valspar/filtered-shade-4003-1b" /> — 4003-1B, LRV 60. A soft, near-neutral gray that stays calm instead of turning cold or blue. Good for bedrooms and hallways where you want gray without a steely cast. Closest matches include Sherwin-Williams Zircon and Benjamin Moore Cement Gray.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#87837B" name="Mountain Smoke" brand="Valspar" href="/colors/valspar/mountain-smoke-6004-2b" /> — 6004-2B, LRV 23. A deep, warm griege-gray for moody accent walls, islands, and built-ins. It is a near-exact match for Benjamin Moore Tweed Coat. Explore more in the <Link href="/colors/family/gray" className="text-brand-blue hover:underline">gray color family</Link>.
        </p>

        <h2 className="mt-10 text-2xl font-bold text-gray-900">Best Valspar Greens</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#CBD0C5" name="Sparkling Sage" brand="Valspar" href="/colors/valspar/sparkling-sage-5005-3b" /> — 5005-3B, LRV 62. One of Valspar&apos;s long-running best-sellers: a pale, gentle sage that pairs with reclaimed wood and white trim. It matches Behr Shy Green closely and lands near Sherwin-Williams Frostwork.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#7C7F70" name="Warm Eucalyptus" brand="Valspar" href="/colors/valspar/warm-eucalyptus-8004-28f" /> — 8004-28F, LRV 21. Valspar&apos;s 2026 Color of the Year (sold as Sage Slate at independent retailers): a restorative green-gray for a serene, grounded room. Its closest cross-brand match is Sherwin-Williams Dried Thyme. See how it compares to the rest of the field in our <Link href="/blog/2026-colors-of-the-year-every-brand-compared" className="text-brand-blue hover:underline">2026 Colors of the Year comparison</Link>.
        </p>

        <h2 className="mt-10 text-2xl font-bold text-gray-900">Best Valspar Blues</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#A0B0B1" name="Blue Arrow" brand="Valspar" href="/colors/valspar/blue-arrow-5001-3c" /> — 5001-3C, LRV 42. A soft, cooled-down blue-gray with a coastal feel — calm enough for a full room. It is a near-exact match for Sherwin-Williams Breezy. Browse the <Link href="/colors/family/blue" className="text-brand-blue hover:underline">blue color family</Link> for more.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#99B6B3" name="Renew Blue" brand="Valspar" href="/colors/valspar/renew-blue-8003-37d" /> — 8003-37D, LRV 44. Valspar&apos;s 2024 Color of the Year: a balanced blue with a grayed sea-green cast that reads spa-like in a bathroom or bedroom. Closest matches are Benjamin Moore Kensington Green and Behr Opal Silk.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#3D5872" name="Indigo Cloth" brand="Valspar" href="/colors/valspar/indigo-cloth-4009-7" /> — 4009-7, LRV 9. A rich, saturated deep blue for cabinetry, islands, and dramatic accent walls. It lands close to Behr Velvet Rope and Benjamin Moore New York State of Mind — a versatile navy alternative.
        </p>

        <h2 className="mt-10 text-2xl font-bold text-gray-900">Best Valspar Statement Colors</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#3F4043" name="Dark Kettle Black" brand="Valspar" href="/colors/valspar/dark-kettle-black-4011-2" /> — 4011-2, LRV 5. A soft, near-true black for front doors, trim, and cabinetry. Used in a low sheen it reads architectural rather than harsh. It is a near-exact match for Behr Totally Black and close to Benjamin Moore Black Jack.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#AE373F" name="Classic Red" brand="Valspar" href="/colors/valspar/classic-red-1009-2" /> — 1009-2, LRV 12. Valspar&apos;s iconic saturated red for a front door or a dining-room statement wall. Its closest cross-brand match is PPG Red Gumball, with Benjamin Moore Lyons Red close behind.
        </p>
