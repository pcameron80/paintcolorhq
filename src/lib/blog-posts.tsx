  ...
  /* ──────────────── Post 0 (newest) ──────────────── */
  {
    ...
    content: () => (
      <>
        ...
        <h2 className="mt-10 text-2xl font-bold text-gray-900">Bright Whites for Small or Windowless Laundry Rooms (LRV 84+)</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
          If your laundry room is windowless or has only a tiny high window, your first job is to throw as much artificial light back into the room as possible. Whites with LRV above 84 reflect more light than they absorb, which is why nearly every contractor defaults to one of these three.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#F5F1EB" name="Chantilly Lace" brand="Benjamin Moore" href="/colors/benjamin-moore/chantilly-lace-2121-70" /> — LRV 92. The cleanest true white in the <Link href="/brands/benjamin-moore" className="text-brand-blue hover:underline">Benjamin Moore</Link> deck, with virtually no undertone. Chantilly Lace does not flash yellow under warm bulbs or blue under cool ones, which makes it the safest pick for a windowless laundry room where you cannot predict bulb behavior. If you only paint one room in the house with Chantilly Lace, the laundry room is a defensible choice.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#F3EEE0" name="Pure White" brand="Sherwin-Williams" href="/colors/sherwin-williams/pure-white-7005" /> — LRV 84. Slightly warmer than Chantilly Lace, with a faint cream undertone. The right pick if your laundry room has wood cabinetry, butcher-block folding counters, brass hardware, or warm-toned tile — Pure White lets those warm elements stay warm without fighting them. The closest <Link href="/match/sherwin-williams/to/benjamin-moore" className="text-brand-blue hover:underline">Benjamin Moore equivalent</Link> lands within Delta E 2.5, so either brand reads identical on the wall.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#F1EDE3" name="Simply White" brand="Benjamin Moore" href="/colors/benjamin-moore/simply-white-2143-70" /> — LRV 91. The middle ground. Just a whisper of warmth without obvious cream. Bright enough to brighten a dim space, warm enough to avoid clinical chill. My default pick when the cabinetry and flooring have not been finalized yet, because it adapts to either direction. For more white options, see our <Link href="/blog/best-white-paint-colors-guide" className="text-brand-blue hover:underline">best white paint colors guide</Link> or browse the full <Link href="/colors/family/white" className="text-brand-blue hover:underline">white color family</Link>.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <h2 className="mt-10 text-2xl font-bold text-gray-900">Soft Greens — The 2026 Direction (LRV 58–67)</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
        ...
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#B8CAD0" name="Sleepy Blue" brand="Sherwin-Williams" href="/colors/sherwin-williams/sleepy-blue-6225" /> — LRV 60. A powder blue with strong gray undertones. Genuinely soothing — it shows up on our shortlist for <Link href="/blog/calming-bedroom-paint-colors" className="text-brand-blue hover:underline">calming bedroom palettes</Link> — and the same quality turns a laundry room from a chore zone into something closer to a small spa. It needs warm wood or brass somewhere in the room to keep it from drifting clinical.
        </p>
        <p className="mt-4 text-gray-700 leading-relaxed">
          <Swatch hex="#B5C7C8" name="Palladian Blue" brand="Benjamin Moore" href="/colors/benjamin-moore/palladian-blue-hc-144" /> — LRV 64. A pale aqua-blue with a green whisper. A Historic Color that has aged better than almost any other in the BM Historical Collection — designers have specified it continuously since the 1990s without it ever feeling dated. The right pick if your laundry room opens off a hallway with white trim and you want it to feel like a deliberate jewel-box rather than a closet. See more in the <Link href="/colors/family/blue" className="text-brand-blue hover:underline">blue color family</Link>.
        </p>

        <h2 className="mt-10 text-2xl font-bold text-gray-900">Warm Neutrals — When the Laundry Connects to a Mudroom (LRV 58–63)</h2>
        <p className="mt-4 text-gray-700 leading-relaxed">
